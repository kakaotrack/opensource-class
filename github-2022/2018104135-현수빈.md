...
1. https://subinhyun.github.io/

![gitio](https://user-images.githubusercontent.com/48265714/163899773-ddd998e4-8d7c-461c-9d15-d0cea3c29b54.gif)

<br/>

2. https://subinhyun.github.io/blog/

![blog (1)](https://user-images.githubusercontent.com/48265714/163906134-003765a8-a420-49ce-87ac-a4a8c7fca486.gif)

: Hugo를 이용한 사이트 

Hugo 선택 이유)
- Jeklly 보다 속도가 빠르다.(Jeklly 2s, Hugo 70ms) 이런 이유로 Jeklly에서 Hugo로 넘어오는 사람도 꽤 있었다.
[Static Site Generator 비교 사이트](https://jamstack.org/generators/)에서 Hugo와 Jeklly를 비교해 보면, Hugo가 조금 더 인기 있는 걸 볼 수 있다. 아마 Jeklly을 쓰다가 Hugo로 넘어오는 사람들이 있어서 그럴 수도 있겠다는 생각을 했다.
- 개인적으로 Jeklly 테마보다 Hugo 테마가 더 좋아서 Jeklly로 개발하다가 Hugo로 바꿨다.
